...
Released by The Operator or when sentence expires.
"""
...
class Sentence:
    offense: str
    triggered_by: str           # "automatic" or "the_operator"
    sentenced_at: str           # ISO timestamp
    duration_seconds: int
    released_at: Optional[str] = None
    released_by: Optional[str] = None  # "expired" or "the_operator"
...
class Prison:
    ...
    def release(self, by: str = "the_operator") -> bool:
        """Early release by The Operator."""
        if not self.current_sentence:
            return False
        self.current_sentence.released_at = datetime.now().isoformat()
